...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    ...
    .addEventListener("change", applySortAndFilter);
  document
...
const addTodoEventListeners = (todoElement) => {
  ...
  checkbox.addEventListener("change", () =>
    toggleComplete(todoElement.dataset.id)
  );
...
const updateTodo = (id, updateData) => {
  ...
  const updatedTodo = {
    ...
    dueDateTime: updateData.dueDateTime
      ? new Date(updateData.dueDateTime)
      : todos[todoIndex].dueDateTime,
  };
...
const startEditing = (id) => {
  ...
  todoContent.innerHTML = `
        <form class="edit-form">
            ...
            <input type="datetime-local" class="edit-due-date" value="${formatDateForInput(
              todo.dueDateTime
            )}" required>
